...
/**
 * This is the model class for table "tbl_hist_trail".
 */
class HistTrail extends CActiveRecord
{
	/**
	 * The followings are the available columns in table 'tbl_hist_trail':
	 * @var integer $id
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, new_value, old_value, action, model, field, stamp, user_id, model_id, valid_from, valid_to', 'safe', 'on'=>'search'),
		);
	}
